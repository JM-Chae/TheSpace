...
public class GetListBoardImpl extends QuerydslRepositorySupport implements GetListBoard
  {
    ...
    public GetListBoardImpl(CategoryRepository categoryRepository)
      {
        super(Board.class);
        this.categoryRepository = categoryRepository;
      }

    public Page<BoardDTO> getList(String[] types, String keyword, Pageable pageable, String path, String category)
      {
